...
|------|------------------|---------|
| [privacy-policy.md](privacy-policy.md) | Store presence → Privacy policy | Host at a public URL, paste the URL. |
...
**Before submitting:** replace the contact email if desired, host the privacy policy, record the FGS demo video, and confirm `targetSdk 37` (Android 17, stable since 16 Jun 2026) is what you ship.
