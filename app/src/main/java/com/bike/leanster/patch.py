...
with open('app/src/main/java/com/bike/leanster/DashboardView.kt', 'r', encoding='utf-8') as f:
    content = f.read()
            ...
            DropdownMenu(
                ...
                DropdownMenuItem(
                    ...
                    onClick = {
                        ...
                        val intent = Intent(
                            Intent.ACTION_VIEW,
                            android.net.Uri.parse("https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=michasteinauer@gmail.com&item_name=Leanster+Donation")
                        )
...
with open('app/src/main/java/com/bike/leanster/DashboardView.kt', 'w', encoding='utf-8') as f:
    f.write(content)
print("SUCCESS")