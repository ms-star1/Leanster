...
data class RideSession(
    ...
    val videoPath: String? = null,   // absolute path to the recorded mp4 (null = ride recorded no video)
    val videoStartTime: Long? = null // epoch ms of the recording's first frame — origin for video↔telemetry sync
)
