...
val KawasakiGreen      = Color(0xFF6FD000)
val MutedKawasakiGreen = Color(0xFF3E7800)

// ── Brand accent: KTM Orange ──────────────────────────────────────────────────
val KtmOrange      = Color(0xFFFC4C02)
val MutedKtmOrange = Color(0xFF8C2A01)

// ── Brand accent: Honda Red ───────────────────────────────────────────────────
val HondaRed      = Color(0xFFCC0000)
val MutedHondaRed = Color(0xFF7A0000)

// ── Brand accent: BMW Blue ────────────────────────────────────────────────────
val BmwBlue      = Color(0xFF0066B1)
val MutedBmwBlue = Color(0xFF003D6B)

// ── Brand accent: Triumph Gold ────────────────────────────────────────────────
val TriumphGold      = Color(0xFFC49A00)
val MutedTriumphGold = Color(0xFF7A5C00)

// ── Brand accent: Husqvarna Yellow ───────────────────────────────────────────
val HusqvarnaYellow      = Color(0xFFFFE500)
val MutedHusqvarnaYellow = Color(0xFF7A6B00)
...
val NeonGreen = Color(0xFF6FD000)
